...
const { network, CONTRACT_ADDRESSES, WrappedTokenGatewayV3ABI, WETH_ABI, USDC_ABI, DODOFeeRouteProxyABI } = require('../config/config');
const { showSpinner, confirmTransaction, rl } = require('../utils/utils');
